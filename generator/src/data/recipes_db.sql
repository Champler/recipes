...
CREATE TABLE `images` (
  ...
  CONSTRAINT `images_FK` FOREIGN KEY (`user_recipes_id`) REFERENCES `user_recipes` (`id`)
...
CREATE TABLE `ingredients` (
  ...
  CONSTRAINT `ingredients_FK` FOREIGN KEY (`user_recipes_id`) REFERENCES `user_recipes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-09-24 15:08:21
